...
const Home = () => {
    return (
        <div>
            ...
            Beyond work, I'm deeply engaged in diverse pursuits that invigorate my life. As an active member of a HEMA club, I immerse myself in the art of fencing, drawing inspiration from historical European martial arts. Additionally, I indulge my passion for creativity designing video games, exploring endless possibilities in digital worlds. Away from screens and swords, I find solace in the great outdoors, pursuing the ancient tradition of hunting. When I'm not crafting games or tracking prey, I enjoy the art of cooking, delighting my wife Christina with culinary creations that reflect my love and appreciation for her.            </ImageTextComponent>
